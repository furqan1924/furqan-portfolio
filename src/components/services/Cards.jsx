  ...
  return (
    <>
      <div className=" justify-center md:flex gap-5">
        <div className="max-w-sm mb-4 p-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" data-aos="fade-up"
          ...
          <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">I shape websites according to your vision, effortlessly bringing your ideas to life. Let's collaborate for a seamless web development journey. </p>
        ...
        <div className="max-w-sm mb-4 p-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" data-aos="fade-up"
          ...
          <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">I specialize in creating frontend experiences using React.js. Elevate your web presence with visually captivating and user-friendly designs</p>
        </div>
        ...
        <div className="max-w-sm mb-4 p-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" data-aos="fade-up"
          ...
          <svg className="w-[30px] h-[30px] fill-[#8e8e8e]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <h5 className="mt-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Back-end Developer</h5>
          
          <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">I specialize in constructing backends with Node.js and Express.js, crafting robust RESTful APIs. Enhance your web and app functionality effortlessly with my comprehensive development approach.</p>
